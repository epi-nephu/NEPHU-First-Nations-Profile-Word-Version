...
# ------------------------------------------------------------------------------
# Grouped bar charts - vaccination ----
# ------------------------------------------------------------------------------
f_graph_vaccination <- function(data, x_labels, y_label = "Percentage of children") {
  
  figure <- ggplot(data) +
    geom_col(aes(x = vaccine, y = percent, group = indigenous_status, fill = indigenous_status),
             position = "dodge",
             col      = colour_gray) +
    #
